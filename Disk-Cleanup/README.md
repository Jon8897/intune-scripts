...
#### To run: Invoke-Expression .\diskcleanup.ps1

## Path to find log 
<pre>
C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\DiskCleanup.log
</pre>
...
## Output
This script generates a log file with the results of the Disk Cleanup. The log file is saved to the user's temp directory with the name DiskCleanup.log. You can upload the log file to Intune as a device configuration script output to view the results for each device.
